package gov.nyc.doitt.quartz.spring;
...
import gov.nyc.doitt.quartz.job.FileMonitorJob;



@Configuration
@ConditionalOnProperty(value = "quartz.enabled")
public class SchedulerConfig {
	...
	public JobDetailFactoryBean sampleJobDetail() {
		return createJobDetail(FileMonitorJob.class);
	}
